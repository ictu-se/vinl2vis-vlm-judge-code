...
- `calibration/`: 160-case difficulty-normalized slice, 240-case annotation package metadata, five 240-case human annotation files, majority-vote labels, model--human agreement summaries, 24/72-case middle-band slices, and model-label CSV files.
